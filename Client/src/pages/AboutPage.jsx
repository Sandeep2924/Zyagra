    ...
    <div className="about-container">
      ...
      <section className="about-section">
        <div className="section-content mission-section">
          ...
          <div className="mission-image">
            <img
              src="https://placehold.co/600x400/2C7A7B/FFFFFF?text=Freshness+Delivered"
              alt="Fresh groceries"
            />
          </div>
        </div>
      ...
      <section className="about-section light-bg">
        <div className="section-content story-section">
          <h2>Our Story 📖</h2>
          <p>
            Founded in **Noida** in **2024**, ZYAGRA was born out of a simple
            frustration: why should getting fresh groceries be a chore? Our
            founder, Aarav Sharma, noticed a gap between the local vendors with
